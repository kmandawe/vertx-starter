...
/**
 * Generic Version of {@link MessageCodec}, which can be used for event bus communication. Make sure
 * to use immutable objects. Sending mutable lists will fail if concurrently accessed. For this
 * purpose use {@link io.vertx.core.json.JsonArray} and {@link io.vertx.core.json.JsonObject} as the
 * built in message codecs support it by copying the list. See: {@link
 * io.vertx.core.eventbus.impl.codecs.JsonArrayMessageCodec}
 *
 * <p>Note: Not working with clustered event bus
 *
